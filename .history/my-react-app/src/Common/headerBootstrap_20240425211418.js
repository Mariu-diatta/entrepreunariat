                  ...
                  <div className='row'>
                    <div  className=" col-lg-6">
                      <Nav  style={{textAlign:'center'}}>
                          ...
                          {       
                              (props.valueHeaderState!==null) ?<LogoutButton onClick={logOut}/>:<Link style={change2} onMouseOver={()=>setChange2(maCouleur[0])} onMouseOut={()=>setChange2(maCouleur[1])} className='p-2' to="/login" ><Button variant='outline-primary' className='m-4'>Connexion</Button></Link>
                          }
                      </Nav>
                    </div>
                    <div  className=" col-lg-6">
