      ...
      <form onSubmit={handleSubmit} className="u-clearfix u-form-spacing-40 u-form-vertical u-inner-form" >
        {
            ...
            <div className='col-lg-4'>
              <div className='form-floating md-form p-1'>
                <FloatingLabel controlId="floatingInput"  label="Votre email"  className="mb-3"  >
                  <Form.Control id="floatingInput" name={Email} value={Email} onChange={(e)=>setEmail(e.target.value)} type="Email" placeholder="Votre email" maxLength="30" className="u-align-center u-input" style={{textAlign:'center'}} />
                </FloatingLabel>
              </div>
              <div className='form-floating md-form p-1'>
          ...
          <div className="row u-align-center u-form-group u-form-submit u-label-none u-form-group-4" >
              ...
              <FloatingLabel controlId="floatingPassword2" label="Votre mot de pass" className='col-lg-4 mb-3'>
