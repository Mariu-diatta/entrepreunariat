...
function LogIn(props) {
  ...
  return (
    <div>
      <Form  style={{backgroundColor:'blue', marginLeft:'20px', width:'30%', marginLeft:'35%', marginTop:'10%', paddingRight:'0px'}} validated={validated} onSubmit={handleSubmit} ref={formRef} className='u-align-center u-form-group u-form-submit u-label-none u-form-group-4'>
