...
function LogIn(props) {
  ...
  return (
    <div >
    <Form  style={{backgroundColor:'blue', width:'50%', paddingLeft:30%}} validated={validated} onSubmit={handleSubmit} ref={formRef} className='u-align-center u-form-group u-form-submit u-label-none u-form-group-4'>
