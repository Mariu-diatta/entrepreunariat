                                ...
                                <div className="m-1 p-4 row" style={{backgroundColor:"", textAlign:'center', paddingTop:'15px', paddingBottom:'20px'}}>
                                    ...
                                    <form>
                                        <FloatingLabel controlId="floatingPassword2" label="Votre nom" className=' mb-3'>
                                            <Form.Control  id="floatingPassword2" name="nom" value="nom"  type="nom" placeholder="Enter a valid email address"  maxLength="30" className="u-align-center u-input" />
                                        </FloatingLabel>

                                        <FloatingLabel controlId="floatingPassword2" label="Votre prénom" className=' mb-3'>
                                            <Form.Control  id="floatingPassword2" name="prenom" value="prenom"  type="text" placeholder="Enter a valid email address"  maxLength="30" className="u-align-center u-input" />
                                        </FloatingLabel>

                                        <FloatingLabel controlId="floatingPassword2" label="Votre numéro" className=' mb-3'>
                                            <Form.Control  id="floatingPassword2" name="tel" value="tel"  type="text" placeholder="Enter a valid email address"  maxLength="30" className="u-align-center u-input" />
                                        </FloatingLabel>
