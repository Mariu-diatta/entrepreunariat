                  ...
                  <div className='row'>
                    <div  className=" col-lg-6">
                      <Nav  style={{textAlign:'center'}}>
                          <Link className='p-2 ' to="/" style={change} onMouseOver={()=>setChange(maCouleur[0])} onMouseOut={()=>setChange(maCouleur[1])} onClick={notprivatepage}><small style={{color:''}} className='d-flex '><i className="fa fa-home fa-lg" aria-hidden="true"> <div>Accueil</div></i> </small></Link>
                          <Dropdown >
