      ...
      <form onSubmit={handleSubmit} className="u-clearfix u-form-spacing-40 u-form-vertical u-inner-form" >
        {
          ...
          <div className="u-align-center u-form-group u-form-submit u-label-none u-form-group-4">
            <div className='p-3'>
              <input ref={addInputs}  name={email} value={email} onChange={(e)=>setEmail(e.target.value)} type="email" placeholder="Enter a valid email address" width={20} maxLength="30" className="u-align-center u-input" />
            </div>
            <div className='p-3'>
