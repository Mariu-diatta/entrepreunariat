      ...
      <form onSubmit={handleSubmit} className="u-clearfix u-form-spacing-40 u-form-vertical u-inner-form" >
        {
          ...
          <div className="u-align-center u-form-group u-form-submit u-label-none u-form-group-4">
            ...
            <div className='p-3'>
              <input  name={password} value={password} onChange={(e)=>setPassword(e.target.value)} type="password" placeholder="Mot de passe"  maxLength="30" className="u-align-center u-input" />
            </div>
          </div>
          :
          <div className="u-align-center u-form-group u-form-submit u-label-none u-form-group-4" >
