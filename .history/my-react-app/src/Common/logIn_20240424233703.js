...
function LogIn(props) {
 ...
 const handleSubmit=(event)=>{
  ...
  return (
    <div>
      <Form  style={{backgroundColor:'white', borderRadius:'6px',minWidth:'350px', width:'30%', marginLeft:'35%', marginTop:'10%', paddingRight:'0px'}} validated={validated} onSubmit={handleSubmit}  className='u-align-center u-form-group u-form-submit u-label-none u-form-group-4'>
