            ...
            <div className="u-form u-form-1 " >
                  ...
                  <form onSubmit={handleSubmit} className="u-clearfix u-form-spacing-40 u-form-vertical u-inner-form" source="email">
                      ...
                      <FloatingLabel controlId="name-e4cc5"  className="u-form-email u-form-group u-form-partition-factor-2 u-label-none u-form-group-2">
                        <Form.Control ref={addInputs}  name={mail} value={mail} onChange={(e)=>setMail(e.target.value)} type="email" placeholder="Enter a valid email address" id="email-e4cc"  maxLength="30" className="u-align-center u-input"  wfd-id="id410"/>
                      </FloatingLabel>
                      <FloatingLabel controlId="name-e4cc6" className="u-form-group u-form-name u-form-partition-factor-2 u-label-none u-form-group-1">
                        <Form.Control ref={addInputs} name={password} value={password} onChange={(e)=>setPassword(e.target.value)} type="password" placeholder="Mot de passe" id="name-e4cc2"  maxLength="30" className="u-align-center u-input" required="" wfd-id="id409" size="2"/>
                      </FloatingLabel>
                      <FloatingLabel className="u-form-group u-form-name u-form-partition-factor-2 u-label-none u-form-group-1">
                        <label htmlFor="name-e4cc" className="u-label u-text-body-color u-label-1">Téléphone</label>
                        <Form.Control ref={addInputs} name={password1} value={password1} onChange={(e)=>setPassword1(e.target.value)} type="password" placeholder="Confirmer mot de passe" size="2"  id="name-e4cc2"  maxLength="30" className="u-align-center u-input" required="" wfd-id="id409" />
                      </FloatingLabel>
                      <FloatingLabel className="u-form-group u-form-message u-label-none u-form-group-3">
                        ...
                        <Form.Control  accept="image/*"  ref={addInputs} placeholder='profile' name={photo} value={photo} onChange={handleImageChange} type="file"  className='pt-2 ' style={{border:'0px'}}/>
