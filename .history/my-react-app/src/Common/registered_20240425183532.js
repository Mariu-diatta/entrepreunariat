        ...
        <form onSubmit={handleSubmit} className="u-clearfix u-form-spacing-40 u-form-vertical u-inner-form" >
          <div className="row u-align-center u-form-group u-form-submit u-label-none u-form-group-4 " >
            ...
            <div className='col-lg-6'>
              ...
              <Row>
                <FloatingLabel controlId="name-e4cc8" label="Votre photo " className="form-floating md-form ">
                  <Form.Control  type="file" accept="image/*"   placeholder='profile' name={photo} value={photo} onChange={handleImageChange}   className='pt-2 ' style={{border:'0px'}}/>
                </FloatingLabel>
              </Row>
