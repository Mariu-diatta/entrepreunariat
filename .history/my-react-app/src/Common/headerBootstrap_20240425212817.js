  ...
  return (
    <div className='row ' style={{maxWidth:window.widt}}>
      <Navbar key={'lg'} expand={'lg'} className="header_ sticky-top " style={{backgroundColor:'black'}}>
        <Container fluid>
          <Navbar.Brand href="#">
          <strong  className='p-4' style={{color:'white'}}>VirtualB</strong>
          </Navbar.Brand>
            ...
            <Offcanvas.Body>
             ...
             <div className='row' >
                <div className='col-md-2 p-2' style={{color:'white'}}>
                  <Button variant='outline-primary' style={{border:'0px'}}> Commerçants</Button>
                </div>
                <div className='col-md-2 p-2' style={{color:'white'}}>
                  <Button variant='outline-primary' style={{border:'0px'}}> Acheteurs</Button>
                 </div>
