          ...
          > 
            ...
            <Offcanvas.Body>
              ...
              <Nav style={{paddingLeft:'100px'}}>
                  ...
                  {       
                      (props.valueHeaderState!==null) ?<LogoutButton onClick={logOut}/>:<Link style={change2} onMouseOver={()=>setChange2(maCouleur[0])} onMouseOut={()=>setChange2(maCouleur[1])} className='' to="/login" ><Button variant='outline-primary'>Connexion</Button></Link>
                  }
              </Nav>
