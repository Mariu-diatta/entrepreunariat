                  ...
                  <div className='row'>
                    <div  className=" col-lg-6">
                      <Nav  style={{textAlign:'center'}}>
                          <Link className='p-2 d-flex' to="/" style={change} onMouseOver={()=>setChange(maCouleur[0])} onMouseOut={()=>setChange(maCouleur[1])} onClick={notprivatepage}><small style={{color:''}}><i className="fa fa-home fa-lg" aria-hidden="true"> Accueil</i> </small></Link>
                          <Dropdown >
