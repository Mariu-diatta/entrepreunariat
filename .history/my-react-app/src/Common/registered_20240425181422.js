            ...
            <div className='col-lg-6'>
              ...
              <div className='row'>
                <FloatingLabel controlId="name-e4cc8" label="Votre description" className="form-floating md-form p-1 mb-3 ">
                  <Form.textarea  name={message} value={message} onChange={(e)=>setMessage(e.target.value)} placeholder="Description de votre activité" rows="4" cols="50" id="message-e4cc" maxLength="1000" minLength="100"  className="u-align-center u-input" required=""></Form.textarea>
                </FloatingLabel>
              </div>
