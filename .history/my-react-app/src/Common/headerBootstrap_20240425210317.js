...
function HeaderBoot(props) {
  ...
  return (
    <div className='row ' style={{maxWidth:window.widt}}>
      <Navbar key={'lg'} expand={'lg'} className="header_ sticky-top " style={{backgroundColor:'black important!'}}>
        <Container fluid>
          <Navbar.Brand href="#">
          <strong  style={{color:'white', paddingLeft:'20px'} }>VirtualB</strong>
          </Navbar.Brand>
                  ...
                  <div className='row'>
                    <div  className=" col-lg-6">
                      <Nav  style={{textAlign:'center'}}>
                          <Link className='p-2 d-flex flex-row' to="/" style={change} onMouseOver={()=>setChange(maCouleur[0])} onMouseOut={()=>setChange(maCouleur[1])} onClick={notprivatepage}><small style={{color:''}}><i className="fa fa-home fa-lg" aria-hidden="true"> Accueil</i> </small></Link>
                          <Dropdown >
