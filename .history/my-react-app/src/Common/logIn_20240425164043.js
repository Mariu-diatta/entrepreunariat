      ...
      <form onSubmit={handleSubmit} className="u-clearfix u-form-spacing-40 u-form-vertical u-inner-form" >
        {
          ...
          <div className="row u-align-center u-form-group u-form-submit u-label-none u-form-group-4 " >
            ...
            <div className='col-lg-4'>
              <div className='p-3'>
                <input   name={Email} value={Email} onChange={(e)=>setEmail(e.target.value)} type="Email" placeholder="Votre email" maxLength="30" className="form-floating  u-align-center u-input" />
              </div>
              <div className='p-3'>
                <input  name={password} value={password} onChange={(e)=>setPassword(e.target.value)} type="password" placeholder="Votre mot de pass"  maxLength="30" className="form-floating  u-align-center u-input" />
              </div>
            </div>
