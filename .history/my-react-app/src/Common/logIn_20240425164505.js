          ...
          <div className="row u-align-center u-form-group u-form-submit u-label-none u-form-group-4 " >
            ...
            <div className='col-lg-4'>
              <div className='form-floating md-form p-3'>
                <input  id="floatingInput"  name={Email} value={Email} onChange={(e)=>setEmail(e.target.value)} type="Email" placeholder="Votre email" maxLength="30" className="  u-align-center u-input" />
                <label htmlFor="floatingInput" ><i class="fas fa-envelope-open pr-4"></i>Adresse email</label>
              </div>
              <div className='form-floating md-form p-3'>
                <input  name={password} value={password} onChange={(e)=>setPassword(e.target.value)} type="password" placeholder="Votre mot de pass"  maxLength="30" className="  u-align-center u-input" />
                <label htmlFor="floatingPassword"><i class="fa fa-unlock-alt pr-4" aria-hidden="true"></i> Mot de passe</label>
              </div>
            </div>
