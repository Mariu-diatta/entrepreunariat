                        ...
                        <div className="m-1 p-4 row" style={{ textAlign:'center', paddingTop:'15px', paddingBottom:'20px'}}>
                            ...
                            <form>
                                <Form.Control controlId="floatingInput1" label='Votre nom' className="u-form-group u-form-name u-form-partition-factor-2 u-label-none u-form-group-1" style={{paddingLeft:'20%', paddingRight:'20%'}}>    
                                    <Form.Control type="text" id="Nom" name="Nom"  className="u-align-center u-input" maxlength="20" placeholder="Nom"/><br/>
                                </Form.Control>
                                <Form.Control controlId="floatingInput2" label='Votre prénom'  className="u-form-group u-form-name u-form-partition-factor-2 u-label-none u-form-group-1" style={{paddingLeft:'20%', paddingRight:'20%'}}>
                                    <Form.Control type="text" id="Prenom" name="Prenom" className="u-align-center u-input" maxlength="20" width={""} placeholder="Prénom" /><br/>
                                </Form.Control>
                                <Form.Control controlId="floatingInput3" label='Votre numéro' className="u-form-group u-form-name u-form-partition-factor-2 u-label-none u-form-group-1" style={{paddingLeft:'20%', paddingRight:'20%'}}>
                                    <Form.Control type="text" id="numero" name="numero" className="u-align-center u-input" maxlength="20" placeholder="numéro"/><br/>
                                </Form.Control>
