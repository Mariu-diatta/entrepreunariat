          ...
          > 
            ...
            <Offcanvas.Body>
              ...
              <Nav style={{paddingLeft:'100px'}}>
                  ...
                  {       
                      (props.valueHeaderState!==null) ?<LogoutButton onClick={logOut}/>:<Link style={change2} onMouseOver={()=>setChange2(maCouleur[0])} onMouseOut={()=>setChange2(maCouleur[1])} className='p-2' to="/login" ><small><Button variant='outline-primary'>Connexion</Button></small></Link>
                  }
              </Nav>
