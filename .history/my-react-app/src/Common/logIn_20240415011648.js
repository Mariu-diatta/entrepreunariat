...
function LogIn(props) {
  ...
  return (
    <div>
    <Form  validated={validated} onSubmit={handleSubmit} ref={formRef} className='u-align-center u-form-group u-form-submit u-label-none u-form-group-4'>
      <h4 className="u-alligne-center pt-2" >{passOublie?'Connexion!':"Mail de recupération"}</h4>
      {
        ...
        <div className='u-align-center u-form-group u-form-submit u-label-none u-form-group-4'>
          <Row className="ml64  u-align-center u-form-group u-form-submit u-label-none u-form-group-4" >
          ...
          <Row className="ml-4 u-align-center u-form-group u-form-submit u-label-none u-form-group-4" >
