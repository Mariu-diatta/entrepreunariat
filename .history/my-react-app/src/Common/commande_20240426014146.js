                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6  " style={{backgroundColor:"white", marginLeft:"0px"}}>
                                ...
                                <div className="m-1 p-4 row" style={{backgroundColor:"", textAlign:'center', paddingTop:'15px', paddingBottom:'20px'}}>
                                    ...
                                    <form>
                                    <Form.Control controlId="floatingInput1" label='Votre nom' className="form-floating md-form mb-3"  >    
                                    <Form.Control type="input" id="floatingInput1" name="Nom"  className="u-align-center u-input" maxlength="20" placeholder="Nom"/><br/>
                                </Form.Control>
                                <Form.Control controlId="floatingInput2" label='Votre prénom'  className="form-floating md-form mb-3"  >
                                    <Form.Control type="text" id="floatingInput2" name="Prenom" className="u-align-center u-input" maxlength="20"  placeholder="Prénom" /><br/>
                                </Form.Control>
                                <Form.Control controlId="floatingInput3" label='Votre numéro' className="form-floating md-form mb-3"  >
