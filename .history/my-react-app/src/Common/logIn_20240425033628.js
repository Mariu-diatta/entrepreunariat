...
function LogIn(props) {
 ...
 const handleSubmit=(event)=>{
  ...
  return (
    ...
    <div className=" u-align-center u-form-email u-form-group  u-label-none u-form-group-4" style={{paddingTop:'30px'}}>
      <h4 >Connexion!</h4>
      <form onSubmit={handleSubmit} className="u-clearfix u-form-spacing-40 u-form-vertical u-inner-form" >
        {
          passOublie?
          <div className="u-align-center u-form-group u-form-submit u-label-none u-form-group-4" style={{paddingLeft:'30%', paddingRight:'30%'}}>
            <div className='p-3'>
              <input ref={addInputs}  name={email} value={email} onChange={(e)=>setEmail(e.target.value)} type="email" placeholder="Enter a valid email address" id="email-e4cc"  maxLength="30" className="u-align-center u-input" />
            </div>
            <div className='p-3'>
              <input ref={addInputs} name={password} value={password} onChange={(e)=>setPassword(e.target.value)} type="password" placeholder="Mot de passe" id="name-e4cc2"  maxLength="30" className="u-align-center u-input" />
            </div>
          </div>
          :
