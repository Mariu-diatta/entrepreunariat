        ...
        <div className="u-align-center u-section-6 u-grey-10 " style={{ paddingTop:'1%' , width:'100%'}}>
            <div className="u-form u-form-1 " >
                  ...
                  <form onSubmit={handleSubmit} className="u-clearfix u-form-spacing-40 u-form-vertical u-inner-form" source="email">
                      <FloatingLabel controlId="name-e4cc" label="Vore nom"  className=" u-form-group u-form-name u-form-partition-factor-2 u-label-none u-form-group-1">
                        <Form.Control id="name-e4cc" name={name} value={name} onChange={(e)=>setName(e.target.value)} type="text"  placeholder="Nom"  maxLength="30" className="u-align-center u-input" required="" wfd-id="id409" size="40"/>
                      </FloatingLabel>
                      <FloatingLabel controlId="name-e4cc1" label="Votre prénom" className="u-form-group u-form-name u-form-partition-factor-2 u-label-none u-form-group-1">
