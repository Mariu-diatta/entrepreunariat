                                ...
                                <div className="m-1 p-4 row" style={{backgroundColor:"", textAlign:'center', paddingTop:'15px', paddingBottom:'20px'}}>
                                    ...
                                    <form>
                                        ...
                                        <FloatingLabel controlId="floatingPassword2" label="Votre mot de pass" className=' mb-3'>
                                            <Form.Control  id="floatingPassword2" name="" value="" onChange="" type="Email" placeholder="Enter a valid email address"  maxLength="30" className="u-align-center u-input" />
                                        </FloatingLabel>

                                        <FloatingLabel controlId="floatingPassword2" label="Votre mot de pass" className=' mb-3'>
                                            <Form.Control  id="floatingPassword2" name="" value="" onChange="" type="text" placeholder="Enter a valid email address"  maxLength="30" className="u-align-center u-input" />
                                        </FloatingLabel>
