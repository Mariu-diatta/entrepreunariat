...
const Photopanel2 = (props)=>{
    ...
    return(
        <div className='card p-0 m-2' onMouseOut={()=> setCouleurImage(false)} onMouseOver={()=> setCouleurImage(true)} style={{backgroundColor:couleurImageActivate?couleur:couleurInit, width:'310px', height:'350px'}}>
         <img src={props.image} className="card-img-top" alt="..." width={100} height={180}/>
         <h6>{props.title}</h6>
         <p className="price p-0 m-0">{props.price}</p>
