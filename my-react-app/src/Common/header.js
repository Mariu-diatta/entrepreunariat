            ...
            <nav className=" u-menu-1">
              ...
              <div className="u-custom-menu u-nav-container" >
                <ul className="u-nav u-unstyled u-nav-1">
                    ...
                    </li><li className="u-nav-item"><a className="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-4-light-1 u-text-palette-1-base" style={{padding: "10px 20px", color:"green"}}><Link to="/inscription">Inscription</Link></a>
                    </li><li className="u-nav-item"><a className="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-4-light-1 u-text-palette-1-base" style={{padding:"10px 20px" }}><button className="button-sucess btn"><Link to="/login"> LogIn </Link></button></a>
                    </li>
                </ul>
              </div>
            </nav>
